...
export default function MainNav({}) {
  ...
  return (
    <section className="lg:mx-auto lg:container lg:my-6">
      ...
      <div className="bg-ncDark flex container mx-auto justify-between lg:hidden p-3">
        ...
        <div className="flex items-center justify-center cursor-pointer">
          <Image
            ...
            src="/news_cast/public/images/menu_icon.svg"
            id="menu_toggle"
            width="24"
            height="24"
            alt=""
      ...
      <div
        className="lg:flex container mx-auto items-center origin-top delay-300 scale-y-0 absolute inset-x-0 lg:static lg:scale-100 transition-transform justify-between bg-ncDark lg:pr-6"
        id="menu_container"
      >
