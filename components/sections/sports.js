    ...
    <section class="p-4 lg:p-0 container mx-auto">
      <div class="grid grid-cols-1 space-y-6 lg:space-y-0 lg:grid-cols-3 lg:gap-4">
        <div class="col-span-1 lg:col-span-2 divide-y divide-ncDark">
          <h2 class="text-primary-500 font-header text-2xl py-2">Sports</h2>
        ...
        <div class="divide-y divide-ncDark">
          <h2 class="font-header text-primary-500 py-2 text-2xl">
            Stay Connected
          </h2>
          <div class="space-y-8">
            <div class="grid grid-cols-2 gap-2 py-4 gap-y-4">
              <button class="bg-[#4281FF] hover:bg-[#1A66FF] hover:duration-300 py-4 px-2 text-center">
                <div class="flex item-center justify-center gap-4">
                  {/* <img src="../assets/images/facebook.svg" /> */}
                  <p class="text-sm text-white">20000 Followers</p>
                </div>
              </button>
              <button class="bg-[#C23785] hover:bg-[#AF3278] hover:duration-300 py-4 px-2 text-center">
                <div class="flex item-center justify-center gap-4">
                  {/* <img src="../assets/images/instagram.svg" /> */}
                  <p class="text-sm text-white">20000 Followers</p>
                </div>
              </button>
              <button class="bg-[#EF5043] hover:bg-[#ED3A2C] hover:duration-300 py-4 px-2 text-center">
                <div class="flex item-center justify-center gap-4">
                  {/* <img src="../assets/images/youtube.svg" /> */}
                  <p class="text-sm text-white">20000 Followers</p>
                </div>
              </button>
              <button class="bg-[#42C0F5] hover:bg-[#2AB8F4] hover:duration-300 py-4 px-2 text-center">
                <div class="flex item-center justify-center gap-4">
                  {/* <img src="../assets/images/twitter.svg" /> */}
                  <p class="text-sm text-white">20000 Followers</p>
                </div>
              </button>
              <button class="bg-[#1B7BFD] hover:bg-[#026DFD] hover:duration-300 py-4 px-2 text-center">
                <div class="flex item-center justify-center gap-4">
                  {/* <img src="../assets/images/Behance.svg" /> */}
                  <p class="text-sm text-white">20000 Followers</p>
                </div>
              </button>
              <button class="bg-[#F7679D] hover:bg-[#F6518F] hover:duration-300 py-4 px-2 text-center">
                <div class="flex item-center justify-center gap-4">
            ...
            <div
              ...
              class="bg-cover h-60 flex items-center justify-center"
            >
              <h4 class="font-header text-2xl text-white">Ad</h4>
            </div>
          </div>
        </div>
      </div>
